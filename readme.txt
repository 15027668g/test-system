1. How to execute the program?
   ...
   1.2 Login with following account. 
   	1.2.1 Staff ID is (Integer), Password is (String).
   ...
   1.3 New staff
	...
	1.3.2 the Staff ID is assigned by the system, please remember the ID
...
2. How to read source code?
   ...
   2.2 UserInterface
  	 ...
  	 2.2.7 MainFrame contain the design pattern of **chain of responsibility**.
